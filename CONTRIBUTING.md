...
```bash
git clone https://github.com/ramonclaudio/create-claude-statusline.git
...
Found a bug? [Open an issue](https://github.com/ramonclaudio/create-claude-statusline/issues) with:
- Node version
- Operating system
- Error message
- Steps to reproduce
